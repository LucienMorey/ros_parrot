...
if __name__ == "__main__":
    ...
    motor_1_handle = TMotorManager(motor_type="AK80-9", motor_ID=7)
    ...
    while time.time() - start_time < 2:
        print(motor_1_handle.get_output_angle_radians())
        motor_1_handle.set_output_torque_newton_meters(-1)
